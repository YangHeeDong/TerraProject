...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "getUsagesPerDay의 응답 데이터")
public class UsageDay {
    ...
    @Schema(description = "일당 최저 cpu 사용률", example = "0.00")
    private Double minCpuUsage;

    @Schema(description = "일당 최대 cpu 사용률", example = "4.23")
    private Double maxCpuUsage;

    @Schema(description = "일당 평균 cpu 사용률", example = "2.11")
